...
export abstract class DddEnum {
   ...
   */
  public static getAll<T extends DddEnum>(this: any): T[] {
   ...
   */
  public static fromValue<T extends DddEnum>(
    this: any,
    value: number,
  ): T | undefined {
  ...
  public static areEqual(left: DddEnum | null, right: DddEnum | null): boolean {
